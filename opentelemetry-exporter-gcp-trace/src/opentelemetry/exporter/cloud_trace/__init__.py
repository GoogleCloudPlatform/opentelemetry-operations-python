...
MAX_NUM_LINKS = environ.get("CLOUD_MAX_NUM_LINKS", 128)
MAX_NUM_EVENTS = environ.get("CLOUD_EVENT_COUNT_LIMIT", 32)
MAX_EVENT_ATTRS = environ.get("CLOUD_EVENT_ATTR_LIMIT", 4)
MAX_LINK_ATTRS = environ.get("CLOUD_LINK_LIMIT", 32)
MAX_SPAN_ATTRS = environ.get("CLOUD_SPAN_ATTR_LIMIT", 32)
